...
public class mail implements mailRemote, mailLocal {
	...
	public void mail(String subject, String text, String destinataire) throws IOException {
			...
			return new PasswordAuthentication( "mokhtar.benhmida@esprit.tn", "smc0312/*");// Specify the Username and the PassWord
			}
			};
			...
			message.addRecipients(Message.RecipientType.CC, "mokhtar.benhmida@esprit.tn");
			...
			transport.connect("mokhtar.benhmida@esprit.tn", "smc0312/*");
